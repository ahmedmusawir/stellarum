...
function joints_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'sidebar-moose',
		'name' => __('Sidebar Moose', 'jointstheme'),
		'description' => __('The first (primary) sidebar.', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="sidebar-content widget %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'id' => 'sidebar-contact',
		'name' => __('Sidebar Contact', 'jointstheme'),
		'description' => __('The Contact sidebar.', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="sidebar-content widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
